"""HTTP client for Elastic Observability (C30. Email Marketing & Newsletter)."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://api.elastic_observability.com"
...
class ElasticObservabilityClient:
    def __init__(self, api_key: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-elastic_observability/0.1.0"
        }
