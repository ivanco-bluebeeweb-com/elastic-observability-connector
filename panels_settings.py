"""Settings panel for Elastic Observability Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__elastic_observability_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=elastic_observability_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_elastic_observability"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Elastic Observability Settings & Accounts", level=2),
