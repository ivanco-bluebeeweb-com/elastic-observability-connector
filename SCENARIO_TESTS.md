# PST Testing Scenarios for Elastic Observability Connector

## Part A: Authentication & Connectivity Verification
- **Scenario A1: Valid Credential Connect**: `connect_elastic_observability_connector` saves token and validates endpoint.
...
- **Scenario C1: Connection Lifecycle**: Clean disconnect via `disconnect_elastic_observability_connector` without lingering secrets.
